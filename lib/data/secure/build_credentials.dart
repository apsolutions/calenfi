...
/// `tools/oauth_dart_defines.sh` превращает их в `--dart-define=KEY=VALUE`.
/// Публичные релизы на GitHub собираются без них (всё зашитое достаётся из
/// скачанного файла), и экран подключения аккаунта просит ввести свой клиент.
/// Сборки со встроенными клиентами делаются из приватной конфигурации.
///
